window.onload = function()
{
	...
	{
			console.log("Top:"+original[i].x+" "+"Left:"+original[i].y);
	}
	...
	sb.addEventListener("click",function()
	{
		...
		//alert($(block).offset().top);
		//alert($(block).offset().left);
						...
						for(i=0;i<allPos.length;i++)
						{
							...
							{	
								...
								if(numx==402 && numy==504)
								{
									...
									//getAll[11].className="puzzlepiece movablepiece";
									//getAll[14].className="puzzlepiece movablepiece";
									//getAll[14].addEventListener("click", moveLeft(this));//this code makes the piece move when the mouse hovers
								...
								else if(numx==402 && numy==404)
								{
									...
									changeClass(getAll[14]);
									//getAll[10].className="puzzlepiece movablepiece";
									//getAll[13].className="puzzlepiece movablepiece";
									//getAll[14].className="puzzlepiece movablepiece";
								...
								else if(numx==302 && numy==404)
								{
									...
									{
										//this.style.left="100px";
										$(getAll[9]).offset({top:302, left:404});
									})
									getAll[14].addEventListener("click", function()
									{
										//this.style.top="-100px";
								...
								else if(numx==202 && numy==504)
								{
									...
									getAll[11].addEventListener("click", function()
									{
										$(getAll[11]).offset({top:202, left:504});
									})
								}
	...
	function check()
	{
		for(i=0;i<allPos.length;i++)
		{
			var el=getEl(allPos[i].x,allPos[i].y);
			if (!$(el).is("div"))
			{
				alert(numx);
				alert(numy);
				if(numx=402 || numx>102)
				{
					for(k=0;k<getAll.length;k++)
					{
						if($(getAll[k]).offset().top==numx-100 && $(getAll[k]).offset().left==numy)
						{
							return getAll[k];
							/*alert($(getAll[k]).offset().top);
							alert($(getAll[k]).offset().left);
							getAll[k].className= "puzzlepiece movablepiece";
							/*getAll[k].addEventListener("mouseover",function()
							{
								getAll[k].className="puzzlepiece movablepiece";
							});*/
							/*$(getAll[k]).mouseleave(function()
							{
								getAll[k].className="puzzlepiece";
							});*/
							/*for(i=0;i<getAll.length;i++)
							{
								getAll[i].addEventListener("mouseleave",function()
